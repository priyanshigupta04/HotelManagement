    ...
    <div className='bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                        Discover the world's most extraordinary stays with us. From luxurious hotels to unique vacation rentals, we offer a curated selection of accommodations that cater to every traveler's needs. Whether you're seeking adventure, relaxation, or cultural experiences, our platform connects you with unforgettable places to stay around the globe.
                    </p>
